        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-700 dark:text-slate-200 font-sans selection:bg-emerald-500 selection:text-white relative">
            ...
            <nav className={`fixed top-0 w-full z-40 transition-all duration-300 ${isScrolled ? 'bg-white/90 dark:bg-slate-950/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 py-4' : 'bg-transparent py-6'}`}>
                <div className="container mx-auto px-6 flex justify-between items-center">
                    <div className="font-bold text-xl tracking-tighter flex items-center gap-2 text-slate-900 dark:text-slate-200">
                        ...
                        <span>Elijah Bodipo Obiang<span className="text-emerald-600 dark:text-emerald-500">_</span></span>
                    </div>
                    <div className="hidden md:flex gap-8 text-sm font-medium text-slate-500 dark:text-slate-400">
                        {['About', 'Projets', 'Expérience', 'Formation', 'Compétences'].map((item) => (
                            <button
                                key={item}
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        <button
                            onClick={toggleTheme}
                            className="p-2 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white transition-all"
                        ...
                        <a
                            ...
                            download
                            className="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 px-4 py-2 rounded-full border border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white transition-all text-sm font-medium"
                        >
                        ...
                        <a
                            ...
                            className="flex items-center gap-2 bg-emerald-600/10 text-emerald-700 dark:text-emerald-400 px-4 py-2 rounded-full border border-emerald-600/20 hover:bg-emerald-600 hover:text-white transition-all text-sm font-medium"
                        >
            ...
            <section id="about" className="pt-32 pb-20 md:pt-48 md:pb-32 container mx-auto px-6 relative overflow-hidden">
                ...
                <div className="max-w-3xl">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 dark:bg-slate-900 border border-emerald-200 dark:border-slate-800 text-emerald-700 dark:text-emerald-400 text-xs font-medium mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <a href="#projets" onClick={(e) => { e.preventDefault(); scrollToSection('projets'); }} className="flex items-center justify-center gap-2 bg-emerald-600 dark:bg-emerald-500 text-white dark:text-slate-950 px-8 py-3 rounded-lg font-bold hover:bg-emerald-500 dark:hover:bg-emerald-400 transition-all cursor-pointer">
                            Voir mes projets
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {projects.map((project) => (
                            <div
                                ...
                                className="group bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-8 hover:border-emerald-400/50 dark:hover:border-emerald-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-100 dark:hover:shadow-2xl dark:hover:shadow-emerald-900/10 cursor-pointer flex flex-col h-full"
                            >
                                ...
                                <div className="mt-4 flex items-center text-emerald-600 dark:text-emerald-500 text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">
            ...
            <section id="expérience" className="py-20 container mx-auto px-6">
                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-12">Expérience Professionnelle</h2>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {education.map((edu, idx) => (
                            <div
                                key={idx}
                                className="group bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-8 hover:border-emerald-400/50 dark:hover:border-emerald-500/50 transition-all duration-300 hover:shadow-lg relative overflow-hidden"
                            >
                                {/* Decorative gradient */}
                    ...
                    {/* ── Langues (inline after Formation) ── */}
                    <div className="mt-16">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {languages.map((lang, idx) => (
                                <div
                                    key={idx}
                                    className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-6 text-center hover:border-emerald-400/50 dark:hover:border-emerald-500/50 transition-all"
                                >
            ...
            <section id="compétences" className="py-20">
                <div className="container mx-auto px-6">
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-12">Stack Technique</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {Object.entries(skills).map(([category, items]) => (
                            <div key={category} className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-6 hover:border-emerald-400/30 dark:hover:border-emerald-500/30 transition-all">
            ...
            <section id="contact" className="py-20 border-t border-slate-200 dark:border-slate-900">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">Prêt à collaborer ?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
                        <a href="mailto:bodipoobiangelijah@gmail.com" className="flex items-center justify-center gap-2 bg-emerald-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-emerald-500 transition-all">
                            <Mail className="w-5 h-5" />
                            bodipoobiangelijah@gmail.com
                        </a>
                        <a href="tel:+33652704867" className="flex items-center justify-center gap-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-white px-6 py-3 rounded-lg font-medium hover:bg-slate-200 dark:hover:bg-slate-700 transition-all border border-slate-200 dark:border-slate-700">
                        ...
                        <a
                            href="/cv_Bodipo_Obiang.pdf"
                            download
                            className="flex items-center justify-center gap-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-white px-6 py-3 rounded-lg font-medium hover:bg-slate-200 dark:hover:bg-slate-700 transition-all border border-slate-200 dark:border-slate-700"
                        >
                            <Download className="w-5 h-5" />
                            Télécharger mon CV
                        </a>
                    ...
                    <div className="flex justify-center gap-6 text-slate-400 dark:text-slate-500">
                        <a href="https://github.com/elijah-bodipo" className="hover:text-slate-900 dark:hover:text-white transition-colors">
                            <Github className="w-6 h-6" />
                        </a>
                        <a href="https://linkedin.com/in/elijah-bodipo" className="hover:text-slate-900 dark:hover:text-white transition-colors">
            ...
            {selectedProject && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white/80 dark:bg-slate-950/80 backdrop-blur-sm" onClick={() => setSelectedProject(null)}>
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl relative" onClick={e => e.stopPropagation()}>
                        <button
                            onClick={() => setSelectedProject(null)}
                            className="absolute top-4 right-4 p-2 bg-slate-100 dark:bg-slate-800 rounded-full text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-700 transition-all z-10"
                        >
                            <X className="w-5 h-5" />
                        </button>
                        ...
                        <div className="p-8 md:p-12">
                            ...
                            <div className="grid md:grid-cols-2 gap-12">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <a href="#" className="flex items-center justify-center gap-2 w-full bg-emerald-600 text-white py-3 rounded-lg font-bold hover:bg-emerald-500 transition-all">
                                        <Github className="w-5 h-5" />
